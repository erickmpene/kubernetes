...
apt update 
apt-get install -y ca-certificates curl gnupg lsb-release apt-transport-https ntp git sudo 
...
echo "################### INSTALLATION KUBEADM + KUBECTL + KUBELET ####################### "
